...
<body class="Login">
    <form id="form1" runat="server">
        <div class="LoginMenu">
            <asp:TextBox CssClass="LoginText" ID="txtUsername" runat="server" Width="300px" Height="35px" Font-Size="Large" Placeholder="Your username"></asp:TextBox>
            <asp:TextBox CssClass="LoginText" ID="txtPassword" runat="server" Width="300px" Height="35px" Font-Size="Large" TextMode="Password" Placeholder="Your password"></asp:TextBox>
            <br />
